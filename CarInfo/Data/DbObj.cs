        ...
        public static void Initial(AppDbContext content)
        {
            ...
            if (!content.Car.Any())
            {
                content.AddRange(
                    ...
                    new Car { name = "Land Cruiser", shortDesc = "Business class", longDesc = "So comfortable auto for drive", img = "https://s.auto.drom.ru/i24207/c/photos/fullsize/toyota/land_cruiser/toyota_land_cruiser_699944.jpg", price = 100000, isFavourite = true, mark = "Toyota", Year = 2018, avaible = true, Category = Categories["TDI"] }
